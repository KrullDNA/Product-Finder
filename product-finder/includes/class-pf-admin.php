    ...
    public function render_email_styles_box( $post ) {
        ...
        <div class="pf-email-styles-wrap">
            ...
            <div class="pf-dn-grid">
                ...
                <!-- Email Subject Line -->
                <fieldset class="pf-dn-fieldset">
                    <legend><?php esc_html_e( 'Email Subject Line', 'product-finder' ); ?></legend>
                    <p>
                        <label><?php esc_html_e( 'Subject', 'product-finder' ); ?></label><br>
                        <input type="text" name="pf_email[email_subject]" value="<?php echo esc_attr( $es['email_subject'] ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'e.g. Your Personalised Results', 'product-finder' ); ?>">
                        <span class="description"><?php esc_html_e( 'The subject line of the results email. Defaults to "Your [Finder Title] Results".', 'product-finder' ); ?></span>
                    </p>
                </fieldset>

                <!-- Footer Text -->
                <fieldset class="pf-dn-fieldset">
                    <legend><?php esc_html_e( 'Footer Text', 'product-finder' ); ?></legend>
                    <p>
                        <label><?php esc_html_e( 'Footer Message', 'product-finder' ); ?></label><br>
                        <input type="text" name="pf_email[footer_text]" value="<?php echo esc_attr( $es['footer_text'] ); ?>" class="large-text" placeholder="<?php esc_attr_e( 'This email was generated by Product Finder.', 'product-finder' ); ?>">
